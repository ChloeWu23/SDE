...
public class ImperialCollegeLibraryCatalogue implements Library {
    ...
    private static ImperialCollegeLibraryCatalogue instance;
    private final Collection<Book> catalogue = allTheBooks();

    private ImperialCollegeLibraryCatalogue() {
    }


    public static synchronized ImperialCollegeLibraryCatalogue getInstance() {
        if (instance == null) {
            instance = new ImperialCollegeLibraryCatalogue();
        }
        return instance;
    }
